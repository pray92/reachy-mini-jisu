...
- translation :
	...
	- Y axis - 좌 우측 움직임
	- Z axis - 위 아래 움직임
	![[Pasted image 20260322005929.png]]
- rotation :
...
     - Yaw -  Shaking left/right (Rotation around the Z-axis)
	![[Pasted image 20260322010034.png]]
  
### 1.2 Moving the Antennas

2개의 안테나는 개별로 동작하며 개별 각도 값으로 제어된다. 
![[Pasted image 20260322013004.png|342]]
### 1.3 Moving the Base

2개의 안테나는 개별로 동작하며 개별 각도 값으로 제어된다. 
![[Pasted image 20260322013043.png|343]]
...
![[Pasted image 20260322135543.png]]
